        ...
        <section className="py-24 bg-slate-950 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
                <div className="max-w-4xl space-y-8">
                    <h2 className="text-4xl md:text-7xl font-bold text-white tracking-tight leading-[1] uppercase">
                        The CXO/C-Suite <br />
                        <span className="text-amber-500 italic">Won't Wait.</span>
                    </h2>

                    <p className="text-xl md:text-2xl text-slate-300 font-light leading-relaxed">
                        The difference between a ₹30L salary and a ₹1Cr+ package isn’t more hard work—it’s <span className="text-amber-400 font-bold border-b-2 border-amber-500/30">Access and Architecture.</span>
                    </p>

                    <p className="text-lg text-slate-400 font-medium pt-4 uppercase tracking-[0.2em]">
                        Join us at the <span className="text-white">Global CXO Summit 2026.</span>
                    </p>

                    <div className="p-8 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-xl relative group">
                        ...
                        <div className="text-white font-bold text-2xl mb-2">Price: ₹18,000</div>
                    ...
                    <div className="flex flex-col items-center gap-4 pt-12">
                        ...
                        <p className="text-xs font-bold text-amber-500/60 uppercase tracking-[0.2em]">

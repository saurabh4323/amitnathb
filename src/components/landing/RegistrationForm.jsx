        ...
        return (
            <div className="w-full max-w-lg mx-auto p-10 flex flex-col items-center text-center space-y-6 bg-slate-900/40 border border-white/10 rounded-3xl backdrop-blur-xl">
                ...
                <button
                    ...
                    className="w-full py-3.5 rounded-2xl bg-[#25D366] hover:bg-[#128C7E] text-white font-bold transition-all flex items-center justify-center gap-2 active:scale-95 shadow-xl shadow-green-500/20"
                >
    ...
    return (
        <div className="w-full max-w-lg mx-auto bg-slate-900/60 border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden backdrop-blur-xl">
            <div className="px-8 py-6 border-b border-white/5 bg-white/5">
                <h3 className="text-2xl font-bold text-white text-left tracking-tight">Architect Your Future</h3>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 text-left ml-1">Full Name</label>
                        <input
                            required
                            type="text"
                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-white/10 transition-all placeholder:text-slate-600 font-light"
                    ...
                    <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 text-left ml-1">Work Email</label>
                        <input
                            required
                            type="email"
                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-white/10 transition-all placeholder:text-slate-600 font-light"
                ...
                <div className="space-y-1.5">
                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 text-left ml-1">Phone Number</label>
                    <input
                        required
                        type="tel"
                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-white text-sm focus:outline-none focus:border-amber-500/50 focus:bg-white/10 transition-all placeholder:text-slate-600 font-light"
                ...
                <div className="space-y-2 bg-slate-950/40 p-4 rounded-2xl border border-white/5">
                    <div className="flex gap-3 items-start text-left">
                        ...
                        <label htmlFor="consent-checkbox-page" className="text-[10px] text-slate-500 leading-tight block font-light">
                            ...
                            <br />
                            <span className="mt-1 block font-medium opacity-50 italic">Note: We respect your privacy and will ensure that your information is handled in accordance with our privacy policy</span>
                        </label>
                    </div>
                </div>

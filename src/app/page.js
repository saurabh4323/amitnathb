...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">
      ...
      <section id="register" className="py-24 bg-slate-950 relative overflow-hidden border-t border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-7xl font-bold text-white leading-[0.9] uppercase tracking-tight">
                Claim your seat <br />
